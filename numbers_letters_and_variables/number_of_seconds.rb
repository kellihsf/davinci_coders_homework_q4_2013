...
puts "  #{seconds_in_a_day} seconds in an day,"
puts "  #{seconds_in_a_week} seconds in a week"

# This version accounts for leap years
puts "That means when you turn 20, you've been alive for #{(20 * seconds_in_a_year) + (5 * seconds_in_a_day)} seconds,"
puts "and if you make it to 100, you will have lived #{(100 * seconds_in_a_year) + (24 * seconds_in_a_day)} seconds. Make them count!"
